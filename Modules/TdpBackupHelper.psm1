...
function Invoke-TdpBackup {
    param(
        ...
        [string]$TdpDir,
        [string]$SqlServer,
        [System.Security.SecureString]$TsmPassword,
        [string]$TsmOptFile,
    ...
    # Passwort erst hier entschlüsseln - so kurz wie möglich im Klartext im Speicher.
    # Hinweis: tdpsqlc.exe nimmt das Passwort nur als Kommandozeilen-Argument entgegen,
    # das ist eine Einschränkung des TDP-Tools selbst und laesst sich von hier aus nicht vermeiden.
    $plainTsmPassword = [System.Net.NetworkCredential]::new('', $TsmPassword).Password
