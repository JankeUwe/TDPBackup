...
REM SQL Server Instance kommt aus TdpBackup.config (siehe Setup-TdpBackup.ps1), nicht von hier
...
powershell.exe -NoProfile -ExecutionPolicy Bypass ^
  -Command "try { & '%BackupScriptsDir%\Backup-TdpFull.ps1' -ConfigPath '%ConfigPath%' } catch { Write-Error $_.Exception.Message; exit 1 }" ^
  >> %LogFile% 2>&1
