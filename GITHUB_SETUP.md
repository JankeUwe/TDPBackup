...
# Backup-Skript testen (SQL-Instance kommt aus TdpBackup.config)
.\Backup-TdpFull.ps1
```
...
| "Please tell me who you are" | `git config user.email "admin@example.com"` und `git config user.name "Admin"` |
